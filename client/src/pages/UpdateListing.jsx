...
export default function UpdateListing() {
    ...
    return (
        <main className='p-3 max-w-4xl mx-auto min-h-[740px]'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className='flex flex-col flex-1 gap-4'>
                    ...
                    <button disabled={loading || uploading} className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>{loading ? "Updatting..." : "Update Listing"}</button>
